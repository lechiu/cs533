...
public class StoryLineNode
{
  ...
  public StoryLineNodeConnection addPredecessor(Position aPosition, Point aP1, Point aP2, Shape aShape, StoryLineNode aSource)
  {
    return new StoryLineNodeConnection(aPosition, aP1, aP2, aShape, this, aSource);
  }
  ...
  public StoryLineNodeConnection addSuccessor(Position aPosition, Point aP1, Point aP2, Shape aShape, StoryLineNode aTarget)
  {
    return new StoryLineNodeConnection(aPosition, aP1, aP2, aShape, aTarget, this);
  }
