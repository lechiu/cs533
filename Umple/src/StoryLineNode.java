...
public class StoryLineNode
{
  ...
  public StoryLineNode(int aStoryLineNodeid, Position aPosition)
  {
    storyLineNodeid = aStoryLineNodeid;
  ...
  public boolean setStoryLineNodeid(int aStoryLineNodeid)
  {
  ...
  public StoryLineNodeConnection addPredecessor(int aStoryLineNodeid, Position aPosition, Point aP1, Point aP2, Shape aShape, StoryLineNode aSource)
  {
    return new StoryLineNodeConnection(aStoryLineNodeid, aPosition, aP1, aP2, aShape, this, aSource);
  }
  ...
  public StoryLineNodeConnection addSuccessor(int aStoryLineNodeid, Position aPosition, Point aP1, Point aP2, Shape aShape, StoryLineNode aTarget)
  {
    return new StoryLineNodeConnection(aStoryLineNodeid, aPosition, aP1, aP2, aShape, aTarget, this);
  }
